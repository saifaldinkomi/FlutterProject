...
class CommentViewModel extends ChangeNotifier {
  ...
  Future<void> fetchComments() async {
    ...
    try {
      _comments =
          await CommentService.getComments(token, courseId, sectionId, postId);
  ...
  Future<void> editComment(String body, int commentId) async {
    try {
      await CommentService.editComment(
          token, courseId, sectionId, postId, body, commentId);
  ...
  Future<void> deleteComment(int commentId) async {
    try {
      await CommentService.deleteComment(
          token, courseId, sectionId, postId, commentId);
  ...
  Future<void> _fetchCommentLikesData(int commentId) async {
    final likeCount = await CommentService.getCommentLikesCount(
        token, courseId, sectionId, postId, commentId);
    final liked = await CommentService.getCommentLikeStatus(
        token, courseId, sectionId, postId, commentId);
